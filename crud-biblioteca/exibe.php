...
<head>
    ...
    <body class="ml-2">
        <div class="mb-4 mt-4">
            <a href="cadastrar.php" class='btn btn-info no-underline font-weight-bold' class="no-underline text-info font-weight-bold">CADASTRAR</a>
        </div>
        ...
        <div>
            <?php
                ...
                $query_cadastro = "SELECT cod, autor, livro FROM cadastro ORDER BY cod DESC LIMIT $inicio, $limite_resultado";
                ...
                if (($result_cadastro) AND ($result_cadastro->rowCount()  !=0)) {
                    ...
                    while($row_cadastro = $result_cadastro->fetch(PDO::FETCH_ASSOC)){
                        ...
                        echo "<p class='col-md-3 col-xs-12 font-weight-bold text-secondary'>Autor: $autor </p>";
